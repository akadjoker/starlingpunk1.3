...
package starling.display
{
    ...
    public class Image extends Quad
    {
        ...
        public function Image(texture:Texture)
        {
         ...
         public function SetImageRect(rect:Rectangle):void
		{
		SetImageFrame(rect.x, rect.y, rect.width, rect.height);
		}
		public function SetImageFrame(TexX:Number, TexY:Number, W:Number, H:Number):void
        {
		 ...
		 var  FTexWidth :Number=_width;
         var  FTexHeight:Number=_height;
  ...
  TexY2 = (TexY + H) / FTexHeight;
		   ...
		   mVertexData.setTexCoords(0,TexX1, TexY1);
           mVertexData.setTexCoords(1,TexX2, TexY1);
           mVertexData.setTexCoords(2,TexX1, TexY2);
           mVertexData.setTexCoords(3,TexX2, TexY2); 
		...
		public function SetImageFrameFlip(TexX:Number, TexY:Number, W:Number, H:Number,flipx:Boolean,flipy:Boolean):void
        {
...
if (flipx)
{
  TexX2 = TexX / FTexWidth;
  TexX1 = (TexX + W) / FTexWidth;
...
if (flipy)
{
	TexY2 = TexY / FTexHeight;
    TexY1 = (TexY + H) / FTexHeight;
	} else
{
	TexY1 = TexY / FTexHeight;
  TexY2 = (TexY + H) / FTexHeight;
