...
package starling.display
{
    ...
    {
        // members
        private var mscrollFactorX:Number;
		private var mscrollFactorY:Number;
        ...
        public function get transformationMatrix():Matrix
        {
         //  if (mOrientationChanged)
			...
			var cx:Number = SP.camera.scrollx;
			var cy:Number = SP.camera.scrolly;
			var sx:Number = mX - cx * mscrollFactorX;
			var sy:Number = mY - cy * mscrollFactorY;
                ...
                if (mPivotX != 0.0 || mPivotY != 0.0)
                {
                    ...
                    mTransformationMatrix.tx = sx - mTransformationMatrix.a * mPivotX
                                                  - mTransformationMatrix.c * mPivotY;
                    mTransformationMatrix.ty = sy - mTransformationMatrix.b * mPivotX 
			...
			var sy:Number = mY - cy * mscrollFactorY;
                ...
                if (mPivotX != 0.0 || mPivotY != 0.0)
                {
                    mTransformationMatrix.tx = sx - mTransformationMatrix.a * mPivotX- mTransformationMatrix.c * mPivotY;
                    mTransformationMatrix.ty = sy - mTransformationMatrix.b * mPivotX- mTransformationMatrix.d * mPivotY;
                }
        ...
        public function set transformationMatrix(matrix:Matrix):void
        {
			...
			var cx:Number = SP.camera.scrollx;
			var cy:Number = SP.camera.scrolly;
			var sx:Number = matrix.tx - cx * mscrollFactorX;
			var sy:Number = matrix.ty - cy * mscrollFactorY;
        ...
        public function set skewY(value:Number):void 
        {
            ...
            if (mSkewY != value)
            {
                ...
                mOrientationChanged = true;
        		  ...
        		  public function get scrollFactorX():Number { return mscrollFactorX; }
		  public function get scrollFactorY():Number { return mscrollFactorY; }
		  
	
		 public function set scrollFactorX(value:Number):void 
        {
           mscrollFactorX = value;
        }
		public function set scrollFactorY(value:Number):void 
        {
           mscrollFactorY = value;
        }
