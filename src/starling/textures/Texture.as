...
package starling.textures
{
    ...
    public class Texture
    {
                                          ...
                                          scale:Number=1):Texture
        {
		 ...
		 public static function fromBitmapDataRect(data:BitmapData,x:int,y:int,w:int,h:int, generateMipMaps:Boolean=true,
                                              optimizeForRenderToTexture:Boolean=false,
                                              scale:Number = 1):Texture
		{
			...
			tilePixels = data.getPixels(rect);
			tilePixels.position = 0;
			tempData.setPixels(tempData.rect, tilePixels);
			
			return fromBitmapData(tempData,generateMipMaps,optimizeForRenderToTexture,scale);
                                              ...
                                              scale:Number=1):Texture
        {
			...
			concreteTexture.rawWidth  = origWidth;
			concreteTexture.rawHeight = origHeight;
			concreteTexture.Width  = legalWidth;
			concreteTexture.Height = legalHeight;
