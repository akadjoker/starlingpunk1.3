...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
		...
		public  var trisdraw:int;
        
        /** Creates a new Statistics Box. */
        public function StatsDisplay()
        {
            mBackground = new Quad(50, 38, 0x0);
            mTextField = new TextField(88, 80, "", BitmapFont.MINI, BitmapFont.NATIVE_SIZE, 0xffffff);
            mTextField.x = 2;
            ...
            updateText(0, getMemory(), 0,0);
            blendMode = BlendMode.NONE;
        }
        
        private function updateText(fps:Number, memory:Number, drawCount:int,trisCount:int):void
        {
        ...
        private function onEnterFrame(event:EnterFrameEvent):void
        {
            ...
            if (mTotalTime > 1.0)
            {
                updateText(mFrameCount / mTotalTime, getMemory(), mDrawCount-2,trisdraw); // DRW: ignore self
